                        ...
                        <form @submit.prevent="submit" class="space-y-5">
                            ...
                            <div class="flex flex-col gap-3 pt-2">
                                <button
                                    ...
                                    class="w-full py-4 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-indigo-700 transition-all disabled:opacity-50 disabled:cursor-wait flex items-center justify-center gap-2"
                                >
                                    ...
                                    <span v-else>Registrar y Cobrar a Caja</span>
                                </button>
