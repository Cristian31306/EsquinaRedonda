...
<template>
    <div class="h-screen w-full bg-slate-50 flex overflow-hidden font-sans selection:bg-indigo-100 selection:text-indigo-900 antialiased">
        ...
        <aside class="w-20 lg:w-72 bg-indigo-950 text-white flex flex-col z-50 shadow-2xl transition-all duration-300">
            <!-- Brand -->
            <div class="h-24 flex items-center justify-center lg:justify-start lg:px-10 border-b border-indigo-500/30">
            ...
            <!-- Nav -->
            <nav class="flex-1 px-3 lg:px-4 py-8 space-y-10 overflow-y-auto no-scrollbar">
                <!-- Group 1 -->
                <div>
                    <p class="hidden lg:block text-[9px] font-black text-indigo-300 uppercase px-4 mb-4 tracking-[0.2em] opacity-70">Operación</p>
                    <div class="space-y-1">
                        <Link 
                            ...
                            class="flex items-center justify-center lg:justify-start gap-4 p-3.5 rounded-2xl transition-all duration-200 group"
                        >
                ...
                <!-- Group 2 -->
                <div>
                    <p class="hidden lg:block text-[9px] font-black text-indigo-300 uppercase px-4 mb-4 tracking-[0.2em] opacity-70">Administración</p>
                    <div class="space-y-1">
                        <Link 
                        ...
                        >
                            ...
                            <span class="hidden lg:block text-xs font-black uppercase tracking-widest">Caja (Activa)</span>
                        </Link>
                        <Link 
            ...
            <div class="p-4 mt-auto border-t border-indigo-500/30">
                <Link 
                    ...
                    method="post" 
                    as="button"
                    class="w-full flex items-center justify-center lg:justify-start gap-4 p-4 rounded-2xl text-indigo-200 hover:bg-white/10 hover:text-white transition-all duration-200 group"
                >
            ...
            <header v-if="$slots.header" class="h-20 bg-white shadow-sm flex items-center px-10 z-40 no-print border-b border-slate-200">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-right hidden sm:block">
                        ...
                        <p class="text-[8px] font-bold text-slate-400 uppercase tracking-widest mt-1">Admin Activo</p>
                    </div>
