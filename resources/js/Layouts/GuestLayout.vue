...
<template>
    <div class="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6">
        <div class="mb-8 flex flex-col items-center">
            <div
                class="w-16 h-16 bg-indigo-950 rounded-3xl flex items-center justify-center text-white shadow-xl shadow-indigo-100 mb-4 animate-in zoom-in-50 duration-500">
        ...
        <div
            class="w-full max-w-md bg-white border border-slate-200 p-10 rounded-[2.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.04)] animate-in slide-in-from-bottom-4 duration-700">
            <slot />
        </div>
